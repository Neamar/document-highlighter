...
module.exports = function highlightHtml(html, query, options) {
  ...
  ret.indexes.forEach(function(index) {
    ...
    html = html.substr(0, htmlIndex.htmlStartIndex) + options.before + index.content + options.after + html.substr(htmlIndex.htmlEndIndex);
  });
